...
import rmit.elevator.controller.MyController;

import au.edu.rmit.elevator.controller.JClientController;
...
public class RandomElevatorSimulator extends Simulator {
	...
	public RandomElevatorSimulator() {
		...
		Controller controller4 = new MyController();//Modified by Hubert
		Controller controller5 = new JClientController();//Modified by Hubert
		controllers.add(controller1);
		controllers.add(controller2);
		controllers.add(controller3);
		controllers.add(controller4);//Modified by Hubert
		controllers.add(controller5);//Modified by Hubert
