...
public class CarAssignments
{
  ...
  public CarAssignments(String name)
  {
    super();
    carName = name;
  }
  ...
  public void addAssignment(List floors, Assignment base,
  ...
  public Iterator iteratorIncluding(List floors, Assignment base,
                             Assignment endPoint)
  {
