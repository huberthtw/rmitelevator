...
import rmit.elevator.controller.JClientController;
  ...
  extends Simulator
{
  ...
  public RandomElevatorSimulator()
  {
    ...
    Controller controller3 = new MyController();//Modified by Hubert
    Controller controller4 = new JClientController();//Modified by Hubert
    controllers.add(controller1);
    controllers.add(controller2);
    controllers.add(controller3);//Modified by Hubert
